...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun setupTextWatchers() {
        val textWatcher = object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                when (currentFocus) {
                    idEditText -> {
                        idEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        idErrorText.visibility = View.GONE
                    }
                    usernameEditText -> {
                        usernameEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        usernameErrorText.visibility = View.GONE
                    }
                    emailEditText -> {
                        emailEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        emailErrorText.visibility = View.GONE
                    }
                    phoneEditText -> {
                        phoneEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        phoneErrorText.visibility = View.GONE
                    }
                    passwordEditText -> {
                        passwordEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        passwordErrorText.visibility = View.GONE
                    }
                    retypePasswordEditText -> {
                        retypePasswordEditText.background = ContextCompat.getDrawable(this@RegisterActivity, R.drawable.rounded_edit_text)
                        retypePasswordErrorText.visibility = View.GONE
                    }
                }
            }
    ...
    private fun resetInputStyles() {
        ...
        retypePasswordEditText.background = ContextCompat.getDrawable(this, R.drawable.rounded_edit_text)
